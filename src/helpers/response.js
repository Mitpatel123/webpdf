    ...
    otpSend: "OTP send successfully on your register email id!",
    ...
    dataAlreadyExist: (mess)  => { return `${message[0].toUpperCase() + message.slice(1).toLowerCase()} already exists!` },
